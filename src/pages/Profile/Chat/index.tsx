    ...
    <div className={styles.root}>
      ...
      <div className="chat-list" ref={listRef}>
        ...
        {chatList.map((item, index) => {
          return (
            <div className={classnames("chat-item", item.type === "xz" ? "self" : "user")} key={index}>
      ...
      <div className="input-footer">
        <Input className="no-border" onKeyDown={sendMessage} placeholder="请描述您的问题" value={value} onChange={setValue} />
